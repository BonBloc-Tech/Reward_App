...
class RecentActivityDesktopWidget extends StatelessWidget {
  ...
  const RecentActivityDesktopWidget({super.key, required this.onViewPressed});
      ...
      initialIndex: 2, 
            ...
            SingleChildScrollView(
              ...
              child: DataTable(
                ...
                rows: [
                  _dataRow("INV-456", "12.08.2025", "Car Service", "10,000", "1,000", "9,000", "12.08.2026"),
                  _dataRow("INV-879", "01.08.2025", "Service Labour", "20,000", "2,000", "18,000", "01.08.2026"),
                ],
              ),
            ),
          ],
  ...
  DataRow _dataRow(String invoiceId, String date, String activity, String credit, String redeem, String balance, String expiry) {
    return DataRow(cells: [
      DataCell(Text(invoiceId)),
      DataCell(Text(date)),
      DataCell(Text(activity)),
      DataCell(Text(credit)),
      DataCell(Text(redeem)),
